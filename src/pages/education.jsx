...
import Ed1 from "../assets/Education-1.jpg";
import Ed2 from "../assets/Education-2.jpg";
import Ed3 from "../assets/Education-3.jpg";
import Ed4 from "../assets/Education-4.jpg";
import Ed5 from "../assets/Education-5.jpg";
import Ed6 from "../assets/Education-6.jpg";
  ...
  return (
    <div className="bg-gray-50 min-h-screen py-10 px-4 md:px-12">
      ...
      <div className="mb-12 relative">
        ...
        >
          {[Ed1, Ed2, Ed3, Ed4, Ed5, Ed6].map((img, index) => (
