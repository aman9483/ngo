...
import Bar from "../assets/bar4.jpg";
import Line from "../assets/line4.jpg";
import Ed1 from "../assets/Public-1.jpg";
import Ed2 from "../assets/Public-2.jpg";
import Ed3 from "../assets/Public-3.jpg";
import Ed4 from "../assets/Public-4.jpg";
import Ed5 from "../assets/Public-5.jpg";
import Ed6 from "../assets/Public-6.jpg";
import Ed8 from "../assets/Public-8.jpg";
import Ed9 from "../assets/Public-10.jpg";
  ...
  return (
    <div className="bg-gray-50 min-h-screen py-10 px-4 md:px-12">
      ...
      <div className="mb-12 relative">
        ...
        >
          {[Ed1, Ed2, Ed3, Ed4, Ed5, Ed6, Ed8, Ed9].map((img, index) => (
